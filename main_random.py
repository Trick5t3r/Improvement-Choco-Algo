import numpy as np
from algorithms_random import pas_choco_gossip_over_time, choco_gossip_over_time, randomized_gossip, compute_rho, compute_beta, compute_gamma
from visualization_dirige_random import animate_gossip
...
# Run Algorithm
x_history, W_history, rho_history = choco_gossip_over_time(size, nb_permutation, Q, p)
